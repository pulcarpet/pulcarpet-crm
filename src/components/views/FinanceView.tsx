    ...
    <div id="finance-view" className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-emerald-800 uppercase tracking-wider">Kimden Alacağımız Var (Müşteriler)</span>
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-rose-800 uppercase tracking-wider">Kime Ödeme Yapmamız Gerekiyor (Tedarikçiler)</span>
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 pb-3">
        ...
        >
          ...
          <span>Kimden Alacağımız Var (Alacaklar)</span>
        ...
        >
          ...
          <span>Kime Ödeme Yapmamız Gerekiyor (Borçlar)</span>
        ...
        >
          ...
          <span>Kesilen ve Gelen Faturalar</span>
        ...
        >
          ...
          <span>Yapılan Ödemeler ve Tahsilatlar</span>
        </button>
        ...
        >
          ...
          <span>Paraşüt API Ayarları</span>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-2xs overflow-hidden">
            <div className="p-3 bg-slate-50 border-b border-slate-200 flex items-center justify-between text-xs font-bold text-slate-700">
              <span className="flex items-center gap-1.5 text-emerald-800">
                ...
                Kimden Alacağımız Var (Müşteri Alacak Bakiyeleri)
              </span>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-2xs overflow-hidden">
            <div className="p-3 bg-slate-50 border-b border-slate-200 flex items-center justify-between text-xs font-bold text-slate-700">
              <span className="flex items-center gap-1.5 text-rose-800">
                ...
                Kime Ödeme Yapmamız Gerekiyor (Tedarikçi Borç Bakiyeleri)
              </span>
              <span className="text-slate-500 font-normal">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 max-w-xl w-full p-6 space-y-4 my-8">
            ...
            <form onSubmit={handleSaveInvoiceModal} className="space-y-4 text-xs">
              <div className="p-2.5 bg-amber-50 border border-amber-200 rounded-xl flex items-center justify-between gap-2">
                ...
                >
                  Örnek Veriyi Yükle (PA02026000000088 - Sümeyya Sarıca)
                </button>
              </div>

...
import { Search, Bell, Sparkles, User, Layers, RefreshCw, ShieldCheck, LogOut, FileText, FileSpreadsheet, ScanBarcode, Lock, Cloud, Loader2, Smartphone } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2.5 sm:gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-nowrap justify-between md:justify-end w-full md:w-auto">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            {/* Device Whitelist Pairing Button */}
            {onOpenDeviceManagement && (
              <button
                onClick={onOpenDeviceManagement}
                title="Yetkili Cihaz Eşleştirme (Cep Telefonu, Evdeki PC, Ofisteki PC)"
                className="hidden lg:flex p-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 rounded-xl border border-emerald-200 transition-colors items-center gap-1.5 text-xs font-bold cursor-pointer"
              >

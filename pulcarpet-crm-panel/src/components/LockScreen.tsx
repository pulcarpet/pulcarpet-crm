  ...
  const handleUnlock = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const validPasses: Record<string, string> = {
        kadirkorkmaz: 'Kadirkrkmz12..',
        wareh: 'Wareh12..',
        finans: 'Finans12..'
      };

      const expectedPassword = validPasses[currentUser.username.toLowerCase()];
      const isMatch = Boolean(expectedPassword && password.trim() === expectedPassword);

            ...
            <div className="p-3 border-t border-slate-800 bg-slate-900/80 flex items-center justify-between gap-2">
              ...
              {onOpenDeviceManagement && (
                <button
                  ...
                  title="Yetkili Cihaz Eşleştirme"
                  className="py-2.5 px-3 bg-indigo-950/60 hover:bg-indigo-900/80 text-indigo-300 border border-indigo-500/30 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 cursor-pointer transition-colors"
                >
